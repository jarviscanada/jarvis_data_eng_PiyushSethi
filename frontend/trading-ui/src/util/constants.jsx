...
// export const tradersUrl = BACKEND_URL + "/traders";
...
export const traderAccountUrl = BACKEND_URL + "/dashboard/traders/";
export const depositFundsUrl = BACKEND_URL + "/dashboard/trader/deposit/";
export const withdrawFundsUrl = BACKEND_URL + "/dashboard/trader/withdraw/";